			...
			<div class="navbar-default sidebar" role="navigation">
				...
				<div class="sidebar-nav navbar-collapse">
					...
					<ul class="nav" id="side-menu">
						...
						<!-- 관리자관리 시작 -->
						<li><a href="${pageContext.request.contextPath}/pages/masteradmin.jsp"><i class="fa fa-table fa-fw"></i>
								관리자관리</a></li>
						<!-- 관리자관리 끝 -->
				...
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						<li class="active"><a href="${pageContext.request.contextPath}/pages/masteradmin.jsp">Home</a></li>
							<li><a>></a></li>
							<li class="active"><a href="${pageContext.request.contextPath}/pages/masteradmin_info.jsp">개인정보 조회</a></li>
				...
				<div class="modal-body">
					...
					<form action="" method="post">
						<div class="form-group">
							...
							<label for="course_name"></label><input type="text"
								class="form-control" id="course_name" name="course_name"
								placeholder="현재 비밀번호 입력 " required> <label
								for="course_name"> </label><input type="text"
								class="form-control" id="course_name" name="course_name"
								placeholder="새 비밀번호 입력" required> <label
								for="course_name"> </label><input type="text"
								class="form-control" id="course_name" name="course_name"
				...
				<div class="modal-body">
					...
					<form action="" method="post">
						<div class="form-group">
							...
							</label><input type="text" class="form-control" id="course_name"
							name="course_name" placeholder="새 비밀번호 입력" required>
