			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables.jsp">기초정보관리</a></li>
						<li><a>></a></li>
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									...
									<tr>
										...
										data-target="#modifyCourseModal">수정</button>
										</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnDelete" data-toggle="modal"
										data-target="#deleteCourseModal">삭제</button>
										</td>
									</tr>
