			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						<li class="active"><a href="${pageContext.request.contextPath}/pages/index.jsp">Home</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables02.jsp">기초정보관리</a></li>
						<li><a>></a></li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									<tr>
										<td class="center">SUB001</td>
										<td class="center">JAVA</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify" data-toggle="modal"
										data-target="#modifySubjectModal">수정</button>
										</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnDelete" data-toggle="modal"
										data-target="#deleteSubjectModal">삭제</button>
										</td>
									</tr>
									<tr>
										<td class="center">SUB002</td>
									...
									<tr>
										<td class="center">SUB004</td>
										<td class="center">MySQL</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify" data-toggle="modal"
										data-target="#modifySubjectModal">수정</button>
										</td>
									...
									<tr>
										<td class="center">SUB005</td>
										<td class="center">Oracle</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify" data-toggle="modal"
										data-target="#modifySubjectModal">수정</button>
										</td>
				...
				<div class="modal-body">
					...
					<form action="" method="post">
						<div class="form-group">
							<label for="sub_name">과목명</label> <input type="text"
								class="form-control" id="sub_name" name="sub_name"
