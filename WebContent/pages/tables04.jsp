	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables04.jsp">기초정보관리</a></li>
						<li><a>></a></li>
         ...
         <tr><td>ISBN</td><td>2012219055</td></tr>
            </table>'>알기쉽게 해설한 JAVA</a></td>


										<td class="center">12346579</td>
										<td class="center">
