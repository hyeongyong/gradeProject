				...
				<div class="row">
					<div class="" id="nav">
						<ul class="nav navbar-nav">
							...
							<li><a>></a></li>
							<li><a href="${pageContext.request.contextPath}/pages/tables06.jsp">개설과정관리</a></li>
						</ul>
					</div>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnStudentCount").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/pages/tablesstudentcount.jsp");
			});
