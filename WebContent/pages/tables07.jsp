			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables07.jsp">개설 과정 선택</a></li>
									...
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify"
												onclick="location.href='${pageContext.request.contextPath}/pages/tables07_1.jsp'">선택</button>
										</td>
									</tr>
									<!-- <tr class="even gradeC">  -->
									<tr>
										<td class="center">OC002</td>
										<td class="center">JAVA 프로그래밍 응용과정</td>
										<td class="center">2019-01-15</td>
