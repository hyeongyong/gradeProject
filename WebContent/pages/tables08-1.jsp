			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables08.jsp">수강생관리</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables08-1.jsp">과정등록</a></li>
					</ul>
				</div>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnCourseAdd").on("click", function(){
				...
				$("#openCourseAdd #openCourseId").val(oc_id);
				$("#openCourseAdd #openCourse_name").val(oc_name);
				$("#openCourseAdd #course_start_day").val(course_start);
				$("#openCourseAdd #course_end_day").val(course_end);
