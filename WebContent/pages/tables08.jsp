			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/pages/tables08.jsp">수강생관리</a></li>
					</ul>
				</div>
							...
							<table class="table table-bordered table-hover" id="tableStudent">
								<thead>
									<tr class="bgColor01">
										...
										<th class="center">과정등록</th>
										<th class="center">정보</th>
										<th class="center">삭제</th>
										<th class="center">사진등록</th>
									</tr>
								</thead>
								<tbody>
									<!-- <tr class="odd gradeX">  -->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<!-- 제목 -->
					<h4 class="modal-title">패스워드 초기화</h4>
				</div>
				<div class="modal-body">
					<!-- 내용 -->
					<form action="" method="post">
						...
						<div class="form-group">
							<label>전화번호</label> <input type="text" class="form-control"
								id="phone" name="phone" readonly="readonly" value="phone">
						</div>

						<div class="form-group">
							<label>패스워드 초기화</label> <input type="text" class="form-control"
								id="student_pw_init" name="student_pw_init"
								placeholder="패스워드를 입력하세요" required>
						</div>

						<p>패스워드를 초기화 하시겠습니까?</p>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnCourseAdd").on("click", function() {
				window.location.assign("tables08-1.jsp");
			});

			$(".btnCourseCansle").on("click", function() {
				window.location.assign("tables08-2.jsp");
			});
			$(".btnCourseCount").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/pages/tablescoursecount.jsp");
			});
