			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables09-1.jsp">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables09-1-subject.jsp">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables09-1-test.jsp">시험 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/pages/tables09-1-score.jsp">수강생 성적 조회</a></li>
					</ul>
				</div>
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">Java 개발자 양성 과정 Java 개발자 양성 과정</td>
							...
							<table class="table table-bordered table-hover" id="tableTest">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">2018-12-01</td>
										<td class="center">20</td>	
										<td class="center">40</td>
										<td class="center">40</td>
										<td class="center">
											<button class="btn btn-default btn-primary btn-xs" title="OS001_서강준_zip">다운로드</button>
										</td>
									</tr>
									<!-- <tr class="even gradeC">  -->
								</tbody>
						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover" id="tableGrade">
								...
								<tbody>
									<!-- <tr class="odd gradeX">  -->
									<tr>
										<td class="center">S010</td>
										<td class="center">
										<a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
											class="pop1"
											data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/person-placeholder.jpg' style='width:60%;'><div>">스윙스</a>
										</td>
								
										
										<td class="center">010-1122-3344</td>
									...
									<tr>
										<td class="center">S015</td>
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
											class="pop1"
											data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/person-placeholder.jpg' style='width:60%;'><div>">이순신</a>
										</td>
										<td class="center">010-7777-5555</td>
										<td class="center">수료예정</td>
										<td class="center">2019-12-12</td>
										<td class="center">20</td>
									...
									<tr>
										...
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
											class="pop1"
											data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/person-placeholder.jpg' style='width:60%;'><div>">제임스</a>
										</td>
										<td class="center">010-7373-2121</td>
										<td class="center">수료예정</td>
										<td class="center">2019-12-12</td>
							...
							<form class="form-inline" method="POST">
								<div class="form-group">
									...
									<select class="form-control input-sm" id="key" name="key">
										...
										<option value="openCourseName">수강생명</option>
									</select>
									<!-- 검색 단어 입력 폼 -->
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnTest").on("click", function() {
				window.location.assign("tables09-1-socre.jsp");
			});
