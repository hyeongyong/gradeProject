							...
							<table class="table table-bordered table-hover" id="tableStudent">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnStudent">선택</button>
										</td>
									</tr>
							...
							<form class="form-inline" method="POST">
								<div class="form-group">
									...
									<select class="form-control input-sm" id="key" name="key">
										...
										<option value="openCourseName">등록일</option>
										<option value="openCourseName">수강횟수</option>
									</select>
									<!-- 검색 단어 입력 폼 -->
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnStudent").on("click", function(){
				window.location.assign("tables09-2-course.jsp");
			});
