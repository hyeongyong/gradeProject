			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/admin/tables05.jsp">강사계정관리</a></li>
					</ul>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="modal-body">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<div class='checkbox'><label class='checkbox-inline'> <input type='checkbox' name='sub1' value='Java'>Java</label>
							<label class='checkbox-inline'> <input type='checkbox'name='sub2' value='Oracle'>Oracle</label>
							<label class='checkbox-inline'> <input type='checkbox' name='sub3' value='C++'>C++</label>
							<label class='checkbox-inline'> <input type='checkbox' name='sub4' value='Database'>Database</label>
							</div>
						</div>
						...
						function() {
							...
							$(".btnModify")
									.on(
										...
										$(
												"#Instructor_infoModify #instructor_id")
												.val(instructor_id);
										$(
												"#Instructor_infoModify #instructor_name")
												.val(instructor_name);
										$(
												"#Instructor_infoModify #possible_sub")
												.val(possible_sub);
										$(
												"#Instructor_infoModify #instructor_phone")
												.val(instructor_phone);
