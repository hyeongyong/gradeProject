			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables07.jsp">개설 과정 선택</a></li>
									...
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify"
												onclick="location.href='${pageContext.request.contextPath}/views/admin/tables07_1.jsp'">선택</button>
										</td>
									</tr>
