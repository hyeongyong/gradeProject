			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-1.jsp">과목별 성적조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-1.jsp">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-1-subject.jsp">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-1-test.jsp">시험 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-1-score.jsp">수강생 성적 조회</a></li>
					</ul>
				</div>
