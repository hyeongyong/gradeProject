							...
							<table class="table table-bordered table-hover" id="tableTest">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnTest">선택</button>
										</td>
									</tr>
									<!-- <tr class="even gradeC">  -->
								</tbody>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnTest").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/admin/tables09-1-score.jsp");
			});
