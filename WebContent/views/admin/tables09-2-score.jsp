			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-2.jsp">수강생 성적조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-2-course.jsp">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-2-subject.jsp">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-2-test.jsp">시험 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/admin/tables09-2-score.jsp">성적 조회</a></li>
							...
							<table class="table table-bordered table-hover" id="tableStudent">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"  class="pop1"
											  data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/Fotolia07.png'style='width:60%;'><div>">김학생</a></td>
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">Java 개발자 양성 과정</td>
										<td class="center">2019-05-05</td>
										<td class="center">2019-11-23</td>
