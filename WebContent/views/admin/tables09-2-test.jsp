								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><a href="#" data-toggle="popover" data-placement="left" data-trigger="hover" data-html="true" class="pop1"
															data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/yong_profile.png'>">박형용</a></td>
							...
							<table class="table table-bordered table-hover" id="tableTest">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnTest">보기</button>
										</td>
									</tr>
									<!-- <tr class="even gradeC">  -->
								</tbody>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnTest").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/views/admin/tables09-2-score.jsp");
			});
