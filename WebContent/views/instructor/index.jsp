						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									<!-- <tr class="odd gradeX">  -->
									<tr>
										<td class="center">OC004</td>
										<td class="center">MySQL</td>
										<td class="center">2018-06-25</td>
										<td class="center" style="vertical-align: middle;">2018-01-17</td>
										<td class="center" style="vertical-align: middle;"><a href="#" data-toggle="popover" data-placement="left" data-trigger="hover" data-html="true" class="pop1" 
