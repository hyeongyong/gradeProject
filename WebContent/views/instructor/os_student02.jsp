			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="#">강의스케쥴조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/os_student01.jsp">과목별 수강생 조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/os_student01.jsp">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/os_student02.jsp">개설과목 선택</a></li>
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									...
									<tr>
										...
										<td class="center ">
										<button type="button" class="btn btn-primary btn-xs" onclick="location.href='${pageContext.request.contextPath}/views/instructor/os_student03.jsp'">선택</button>
										</td>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/instructor/os_student03.jsp");
			})
