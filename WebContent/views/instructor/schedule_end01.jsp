			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의 일정별 조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_end01.jsp">강의종료 개설과정 선택</a></li>
...
<%-- 								<li ><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의 예정</a></li>
								...
								<li class="active"><a href="${pageContext.request.contextPath}/views/instructor/schedule_end01.jsp">강의 종료</a></li>
							</ul>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/instructor/schedule_end02.jsp");
			});		
		});
	</script>
