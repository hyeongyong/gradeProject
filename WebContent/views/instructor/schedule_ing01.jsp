		...
		<div id="page-wrapper">
				<div class="row">
					...
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_ing01.jsp">강의중 개설과정 선택</a></li>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/instructor/schedule_ing02.jsp");
			});
