			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의일정별 조회</a></li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의예정</a></li>
								<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_ing01.jsp">강의중</a></li>
								<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_end01.jsp">강의종료</a></li>
							</ul>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/instructor/schedule_planned02.jsp");
			});
