					...
					<div class="logo">
						...
						<div class="userInfo">
							<span class="simple-text logo-normal" id="userId">로그인한 ID</span>
     						<button class="btn btn-default" id="" onclick="location.href='${pageContext.request.contextPath}/views/instructor/instructor_info.jsp'">개인정보조회</button>
							<button class="btn btn-default" id="">로그아웃</button>
		...
		$(document).ready(function() {
			...
			$("#btnLogout").on("click", function() {
	         ...
	         $(".btnView").on("click", function() {
	             window.location.assign("${pageContext.request.contextPath}/views/instructor/scoreAddAndRemove02.jsp");
	          });
