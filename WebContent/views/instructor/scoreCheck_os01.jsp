					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="nav nav-tabs">
								...
								<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student01.jsp">수강생기준</a></li>
			...
			$("[data-toggle='popover']").popover();
	         ...
	         $("#btnInfo").on("click", function() {
	          ...
	          $(".btnView").on("click", function() {
	              window.location.assign("${pageContext.request.contextPath}/views/instructor/scoreCheck_os02.jsp");
	           });
