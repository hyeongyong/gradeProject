			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os01.jsp">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os02.jsp">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os03.jsp">시험 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os04.jsp">전체 수강생 성적 조회</a></li>
					</ul>
				</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os01.jsp">과목기준</a></li>
