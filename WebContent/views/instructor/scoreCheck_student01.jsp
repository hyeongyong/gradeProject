			...
			<div class="row content">
				<div class="col-lg-12">		
                    ...
                    <!-- 출력 개수 버튼, 검색 폼 시작 -->
                     ...
                     <form class="form-inline" method="POST" action="${pageContext.request.contextPath}/views/instructor/scoreCheck_student01.jsp">
                        <div class="form-group">
                           ...
                           <select class="form-control input-sm" id="key" name="key">
                              ...
                              <option value="open_course_id">수강생아이디</option>
                              <option value="course_name">수강생명</option>
                           </select>
                           <!-- 검색 단어 입력 폼 -->
		...
		$(document).ready(function() {
			...
			$("[data-toggle='popover']").popover();
	         ...
	         $(".btnView").on("click", function() {
	             window.location.assign("${pageContext.request.contextPath}/views/instructor/scoreCheck_student02.jsp");
	          });
		});
	</script>
