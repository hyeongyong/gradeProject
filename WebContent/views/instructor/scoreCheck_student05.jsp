			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="#">성적관리</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os01.jsp">성적조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student01.jsp">전체 수강생목록</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student02.jsp">개설과정 선택</a></li>
			
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student03.jsp">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student04.jsp">시험선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student05.jsp">특정수강생 성적조회</a></li>
					</ul>
				</div>
			...
			<div class="row content">
				<div class="col-lg-12">		
					...
					<div class="panel panel-default">
						...
						<%-- 		<li ><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_os01.jsp">과목기준</a></li> --%>
								<li class="active"><a href="${pageContext.request.contextPath}/views/instructor/scoreCheck_student01.jsp">수강생기준</a></li>
							...
							<table class="table table-bordered table-hover"
								...
								<tbody>
									<tr >
										...
										<td class="center ">01000000000</td>
