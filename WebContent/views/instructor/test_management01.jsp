			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/instructor/test_management01.jsp">개설과정 선택</a></li>
					</ul>
				</div>
			</div>
			<!-- 콘텐츠 상단 네비게이션 바 끝 -->
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/views/instructor/test_management02.jsp");
			});
