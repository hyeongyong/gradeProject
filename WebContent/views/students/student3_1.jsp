							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr class="bgColor02">
										...
										<th class="center col-md-1">시험<br>날짜
										</th>
								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><button type="button"
												...
												title="OS017_JAVA_2018-08-16">다운로드</button></td>
										<td class="center">2018-08-16</td>
										<td>
											<button class="btn btn-defualt btn-primary btn-xs btnView"
												onclick="location.href='student3_1_2.jsp'">선택</button>
										</td>
									</tr>
									<tr>
										<td class="center">OS006</td>
										<td class="center">Database</td>
										<td class="center">2018-08-17</td>
										<td class="center">2018-09-10</td>
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
											class="pop1"
											title="<div style='text-align:center;'><img src='https://bookthumb-phinf.pstatic.net/cover/133/419/13341936.jpg' style='width:60%;'><div>"
											data-content='<table>
									        			  <tr><td style="width:60px;">제목</td><td>오라클SQL 과 PL/SQL</td></tr>
									        			  <tr><td>저자</td><td>우재남</td></tr>
									        			  <tr><td>가격</td><td>20000</td></tr>
									        			  <tr><td>출판사</td><td>한빛</td></tr>
									        			  <tr><td>ISBN</td><td>2018030255</td></tr>
									        			  </table>'
									       >오라클SQL 과 PL/SQL</a>
									    </td>
										<td class="center"><a href="#" data-toggle="popover"
										...
										<td class="center"><button type="button"
												class="btn btn-primary btn-xs"
												title="OS006_ Database_ 2018-09-10">다운로드</button></td>
										<td class="center">2018-09-10</td>
										<td>
											<button class="btn btn-defualt btn-primary btn-xs btnView"
												onclick="location.href='student3_1_1.jsp'">선택</button>
										</td>
									</tr>
								</tbody>
							</table>
