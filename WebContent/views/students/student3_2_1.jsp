			...
			<div class="row">
				<div class="" id="nav">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/views/students/student.jsp">Home</a></li>
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/students/student3_2.jsp">수강생의 과목</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/views/students/student3_2_1.jsp">수강생의 점수</a></li>
					</ul>
				</div>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr class="bgColor01">
										...
										<th class="center col-md-1">시험문제<br>(.zip)
										</th>
								...
								<tbody>
									<!-- <tr class="odd gradeX">  -->
									<tr>
										<td class="center">OS019</td>
										<td class="center">Visual Basic</td>
										<td class="center">2018-04-01</td>
										<td class="center">2018-05-02</td>
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
											class="pop1"
											title="<div style='text-align:center;'><img src='https://bookthumb-phinf.pstatic.net/cover/116/651/11665171.jpg' style='width:60%;'><div>"
											data-content='<table>
									        			  <tr><td style="width:60px;">제목</td><td>알기 쉽게 해설한 JAVA</td></tr>
									        			  <tr><td>저자</td><td>정선호</td></tr>
									        			  <tr><td>가격</td><td>15000</td></tr>
									        			  <tr><td>출판사</td><td>생능</td></tr>
									        			  <tr><td>ISBN</td><td>2018000001</td></tr>
									        			  </table>'
									       >비주얼 베이직</a></td>
										<td class="center"><a href="#" data-toggle="popover"
											data-placement="left" data-trigger="hover" data-html="true"
										...
										<td class="center"><button type="button"
												...
												title="OS019_Visual Basic_2018-05-02">다운로드</button></td>
										<td class="center">2018-05-02</td>
									</tr>
								</tbody>
							</table>
